 ...
 * Run with: deno run --allow-net --allow-env check-hubspot-properties.ts
 */

const HUBSPOT_API_BASE = "https://api.hubapi.com";
const ACCESS_TOKEN = Deno.env.get("HUBSPOT_ACCESS_TOKEN");
...
async function getPropertyDefinition(propertyName: string) {
  try {
